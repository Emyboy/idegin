...
export default withTheme(props => {
    ...
    return (
        <header className="header clearfix">
            <button type="button" id="toggleMenu" className="toggle_menu" onClick={context.toggleSideNav}>
                <i className="uil uil-bars"></i>
            </button>
            <button id="collapse_menu" className="collapse_menu" onClick={context.toggleSideNav}>
                <i className="uil uil-bars collapse_menu--icon "></i>
                <span className="collapse_menu--label"></span>
            </button>
            <div className="main_logo" id="logo">
                {/* <a href="index.html"><img src="images/logo.svg" alt="" /></a> */}
                <a href="index.html"><b className="h1">iDegin</b> </a>
            ...
            {/* <div className="header_right">
                <ul>
                    ...
                    <li className="ui dropdown" tabindex="0">
                        ...
                        <div className="menu dropdown_account left transition hidden" tabindex="-1">
